...
import com.example.toolbar.ListagemTurma
import com.example.toolbar.api.EnderecoAPI
import com.example.toolbar.api.RetrofitHelper
import com.example.toolbar.databinding.ActivityCadastroTurmaBinding
...
class CadastroTurmaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (turmaId   != -1) {
            binding.edtNomeTurma.setText(intent.getStringExtra("TURMA_CURSO"))
        }

        binding.btnSaveTurma.setOnClickListener {
            val curso = binding.edtNomeTurma.text.toString()
